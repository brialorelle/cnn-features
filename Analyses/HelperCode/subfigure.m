...
%
% % MODIFIED BY TFB 3/11/2012
% % NOW TAKES OPTIONAL 4th ARGUMENT THAT IS THE FIGURE TO MOVE TO THAT
% POSITION
%
%
...
switch nargin
    ...
    case 3
        ...
        n = varargin{2};
        p = varargin{3};
    case 4   % -- MODIFIED BY TFB 3/11/2012
        m = varargin{1};
        n = varargin{2};
        p = varargin{3};
        figHand = varargin{4};
...
% Display figure -- MODIFIED BY TFB 3/11/2012
if isempty(figHand)
  h = figure('Position',pos);
else
  set(figHand, 'Position', pos);
  h = figHand;
end
